...
switch ($action) {
    case 'upload';
        ...
        if ($imageCheck) {
            $message =
            '<p class="message">An image by that name already exists.</p>';
        } elseif (empty($invId) || empty($imgName)) {
            $message = '<p class="message">You must select a vehicle and image file for the vehicle.</p>';
        } else {
            ...
            if ($result) {
                ...
                $message = '<p class="message">Sorry, the upload failed.</p>';
            }
        }
    ...
    case 'delete';
        ...
        if ($remove) {
            $message = "<p class='message success'>$filename was successfully deleted.</p>";
        } else {
            $message = "<p class='message'>$filename was NOT deleted.</p>";
        }
